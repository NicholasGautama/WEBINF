...
<head>
  ...
  <!-- End Navigation -->
      <div class="container-fluid my-5">
        <h3 class="text-center" style="font-size: 50px">Tambah Researh Grants DIKTI</h3>
        </div>
      <div class="bootstrap-table bootstrap4 m-5">
        <div class="row">
          <div class="card">
            <div class="card-body">
            <form action="/isertdatapenelitian" method+="POST" enctype="multipart/form-data">
            @csrf 
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Tahun Penelitian</label>
  ...
  <div class="mb-3">
    ...
    <input type="number" name="skema" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Judul Penelitian</label>
    <input type="text" name="judul_penelitian" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Nama Peneliti</label>
    <input type="text" name="peneliti" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
