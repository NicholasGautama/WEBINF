...
<head>
    ...
    <div class="container-fluid my-5">
        <h3 class="text-center" style="font-size: 50px">Awards</h3>
    </div>
    <style>
    ...
    <div class="container">
          <div class="bootstrap-table bootstrap4 mb-3">
            <a href="adminadd-award" class="btn btn-primary">Tambah</a>
          </div>
        </div>
    <table>
        <thead>
            ...
            <tr data-semester='{{$item->isi}}'>
                    ...
                    <td>
                        <div class="btn-group">
                        <a href="adminedit-award/{{$item-> id}}" class="btn btn-warning" >Edit</a> 
                        <a href="admindelete-award/{{$item-> id}}" class="btn btn-danger" >Delete</a>
                        </div>
                    </td>
            </tr>
            @endforeach
