...
@section('content')
    <div class="container-fluid my-5">
        <h3 class="text-center" style="font-size: 50px">Add Copyright Inovation</h3>
    </div>
        <div class="bootstrap-table bootstrap4 m-5">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <form action="adminaddinovasi2" method="post">
                            @csrf 
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="namap1" class="form-control" id="namap1" required>
                            </div>
                            <div class="mb-3">
                                <label for="nidn1">NIDN Penulis 1</label>
                                <input type="text" name="nidn1" class="form-control" id="nidn1" required>
                            </div>
                            <div class="mb-3">
                                <label for="programstud">Program Studi</label>
                                <input type="text" name="programstud" class="form-control" id="programstud" required>
                            </div>
                            <div class="mb-3">
                                <label for="namap2">Penulis 2</label>
                                <input type="text" name="namap2" class="form-control" id="namap2" required>
                            </div>
                            <div class="mb-3">
                                <label for="nidn2">NIDN Penulis 2</label>
                                <input type="text" name="nidn2" class="form-control" id="nidn2" required>
                            </div>
                            <div class="mb-3">
                                <label for="namap3">Penulis 3</label>
                                <input type="text" name="namap3" class="form-control" id="namap3" required>
                            </div>
                            <div class="mb-3">
                                <label for="nidn3">NIDN Penulis 3</label>
                                <input type="text" name="nidn3" class="form-control" id="nidn3" required>
                            </div>
                            <div class="mb-3">
                                <label for="namap4">Penulis 4</label>
                                <input type="text" name="namap4" class="form-control" id="namap4" required>
                            </div>
                            <div class="mb-3">
                                <label for="nidn4">NIDN Penulis 4</label>
                                <input type="text" name="nidn4" class="form-control" id="nidn4" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nodaftar" class="form-control" id="nodaftar" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tautan" class="form-control" id="tautan" required>
                            </div>
                            <div class="mb-3">
