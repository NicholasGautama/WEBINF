...
@section('content')
    <div class="container-fluid my-5">
        <h3 class="text-center" style="font-size: 50px">Delete Mata Kuliah Merdeka</h3>
    </div>
          ...
          <div class="row">
            <div class="card">
              <div class="card-body">
                    ...
                    <div class="mb-3" >
                        <form style="display: inline-block" action="/admindelete-merdeka/{{$merdeka->id}}" method="post">
                            @csrf
                            @method('delete')
