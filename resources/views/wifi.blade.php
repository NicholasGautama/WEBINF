     ...
     <div class="container my-5">
      <div class="card border-0">
        <div class="card-body" style="padding: 1rem 0rem;">
          <h5 class="card-title" style="font-size: 2em;">Wi-Fi Access with Green Environment</h5>
          <p class="card-text">UMN’s Wi-Fi has a free flow system where UMN students are not charged with cellular data when accessing the internet. This Wi-Fi network can cover the entire campus of UMN that guarantees high connection for 24 Hour to provide comfort towards students.</p>
        </div>
        <img class="card-img-top" src="{{ asset('images/wifi.jpg') }}" alt="Card image cap">
      </div>
      </div> 
